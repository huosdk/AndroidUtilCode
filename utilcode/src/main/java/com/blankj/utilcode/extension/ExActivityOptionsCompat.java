 ...
 * fashion.
 */
public class ExActivityOptionsCompat {
    /**
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeCustomAnimation(@NonNull Context context,
                                                              int enterResId, int exitResId) {
        if (Build.VERSION.SDK_INT >= 16) {
            return createImpl(ActivityOptions.makeCustomAnimation(context, enterResId, exitResId));
        }
        return new ExActivityOptionsCompat();
    }
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeScaleUpAnimation(@NonNull View source,
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeClipRevealAnimation(@NonNull View source,
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeThumbnailScaleUpAnimation(@NonNull View source,
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeSceneTransitionAnimation(@NonNull Activity activity,
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeTaskLaunchBehind() {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     */
    @NonNull
    public static ExActivityOptionsCompat makeBasic() {
        if (Build.VERSION.SDK_INT >= 23) {
    ...
    @RequiresApi(16)
    private static ExActivityOptionsCompat createImpl(ActivityOptions options) {
    ...
    @RequiresApi(16)
    private static class ActivityOptionsCompatApi16Impl extends ExActivityOptionsCompat {
        ...
        @Override
        public void update(ExActivityOptionsCompat otherOptions) {
    ...
    private static class ActivityOptionsCompatApi24Impl extends ActivityOptionsCompatApi23Impl {
        ...
        @Override
        public ExActivityOptionsCompat setLaunchBounds(@Nullable Rect screenSpacePixelRect) {
    ...
    protected ExActivityOptionsCompat() {
    }
     ...
     * base options.
     */
    public void update(@NonNull ExActivityOptionsCompat otherOptions) {
        // Do nothing.
    }
